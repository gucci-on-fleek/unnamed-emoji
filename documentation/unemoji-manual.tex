...
\Unemoji/ is an experimental emoji package for \LaTeX{}, Plain~\TeX{}, and
OpTeX. It natively supports \pdfTeX{} and \LuaTeX{}, and can support \XeTeX{}
and any other \TeX{} engine using \type{dvipdfmx} with a patched version of
\type{dvipdfmx}.
...
\Unemoji/ has support for \LaTeX{}, Plain~\TeX{}, and \OpTeX{}. Loading the
...
Finally, if you are using LuaTeX, you can enter the Unicode character directly:
...
\table{(\tt)rl}{
    noto-emoji &
    \emoji[noto-emoji]{1f638} \cr
    %
    twemoji &
    \emoji[twemoji]{1f638} \cr
    %
    fxemoji &
    \emoji[fxemoji]{1f638} \cr
    %
    openmoji &
    \emoji[openmoji]{1f638} \cr
    %
    emojione &
    \emoji[emojione]{1f638} \cr
}
\stoplatex
